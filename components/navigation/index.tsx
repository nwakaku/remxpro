  ...
  return (
    ...
    >
      ...
      <Flex
        ...
        fontSize="xs"
        color="#fff"
        height="20px" // Set the desired height for the footer
      >
        <Text>
          REMX PRO has added AI features that assist users in creating smart
          contracts by suggesting code or providing explanations in plain
          language.
        </Text>
      </Flex>
      <IconButton
